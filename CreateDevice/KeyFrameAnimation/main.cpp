...
void InitAnimation()
{
	g_paniPos[0] = D3DXVECTOR3(0, 0, 0);
	g_paniPos[1] = D3DXVECTOR3(5, 5, 5);
...
VOID Animate()
{
	...
	x = Linear(g_paniPos[0].x, g_paniPos[1].x, t);
	y= Linear(g_paniPos[0].y, g_paniPos[1].y, t);
	z = Linear(g_paniPos[0].z, g_paniPos[1].z, t);
